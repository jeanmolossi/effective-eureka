...
// CreateModuleInCourse is an autogenerated mock type for the CreateModuleInCourse type
type CreateModuleInCourse struct {
	mock.Mock
}

// Run provides a mock function with given fields: module
func (_m *CreateModuleInCourse) Run(module domain.Module) (domain.Module, error) {
