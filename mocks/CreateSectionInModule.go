...
// CreateSectionInModule is an autogenerated mock type for the CreateSectionInModule type
type CreateSectionInModule struct {
	mock.Mock
}

// Run provides a mock function with given fields: section
func (_m *CreateSectionInModule) Run(section domain.Section) (domain.Section, error) {
