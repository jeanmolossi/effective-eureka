...
// GetByCourseID provides a mock function with given fields: filters, _a1
func (_m *ModuleRepository) GetByCourseID(filters ormcondition.FilterConditions, _a1 paginator.Paginator) ([]domain.Module, error) {
	ret := _m.Called(filters, _a1)

	var r0 []domain.Module
	if rf, ok := ret.Get(0).(func(ormcondition.FilterConditions, paginator.Paginator) []domain.Module); ok {
		r0 = rf(filters, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.Module)
