...
// AddLessonInSection is an autogenerated mock type for the AddLessonInSection type
type AddLessonInSection struct {
	mock.Mock
}

// AddLesson provides a mock function with given fields: lesson
func (_m *AddLessonInSection) AddLesson(lesson domain.Lesson) (domain.Lesson, error) {
