...
// SectionUpdater is an autogenerated mock type for the SectionUpdater type
type SectionUpdater struct {
	mock.Mock
}

// Execute provides a mock function with given fields: section
func (_m *SectionUpdater) Execute(section domain.Section) (domain.Section, error) {
